...
import { Navbar, NavbarBrand, Nav, NavbarToggler ,Collapse ,NavItem, Label ,Form, FormGroup, Input
     ,Jumbotron ,Button ,Modal ,ModalBody, ModalFooter, ModalHeader} from 'reactstrap';
                                ...
                                <Nav navbar className="">
                                    ...
                                    <NavItem>
                                        <NavLink className="nav-link" to="/contact">
                                            <span className="fa fa-address-card fa-lg">Contuct</span>
                                        </NavLink>
                                    </NavItem>
                                </Nav>
                                </Collapse>
                        ...
                        <div className="row row-header">
                            <div className="row col-12 col-sm-6">
                                ...
                                <p>We take inspiration from the World's
                                    ...
                                    fusion experience. Our lipsmackin
                                    g creations will tickle your culi
                                    nary senses!</p>
                            </div>
                        </div>
                    </div>
