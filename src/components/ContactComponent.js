...
import {Breadcrumb,BreadcrumbItem , Form, FormGroup, Button, FormGroupProps, Label, Input, Col, FormFeedback, Row } from 'reactstrap';
...
class Contact extends Component {
    ...
    validate(firstname,lastname,telnum,email){
        ...
        if(this.state.touched.telnum && !reg.test(telnum)){
            errors.telnum = 'Telnum is not correct';
        }
